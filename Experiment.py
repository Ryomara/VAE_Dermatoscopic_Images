...
parser.add_argument('--arch', default='fcn', metavar='N',
                    help='architecture')
parser.add_argument('--distribution', default='gaussian', metavar='N',
                    help='architecture')
parser.add_argument('--loss', default='mixture', metavar='N',
                    help='architecture')
            ...
            if i == 0:
                ...
                if arch == 'resnet':
                    save_image(comparison.cpu(),
                             'reconstruction_resnet_' + args.distribution + '_' + args.loss+ '_' + str(epoch) + '.png', nrow=n)
                if arch == 'convlin':
                    save_image(comparison.cpu(),
                             'reconstruction_convlin_'  + args.distribution + '_' + args.loss+ '_' + str(epoch) + '.png', nrow=n)
                if arch == 'fcn':
                    save_image(comparison.cpu(),
                             'reconstruction_fcn_'  + args.distribution + '_' + args.loss+ '_' + str(epoch) + '.png', nrow=n)
                if arch == 'fcn_resn':
                    save_image(comparison.cpu(),
                             'reconstruction_fcn_resn_'  + args.distribution + '_' + args.loss+ '_' + str(epoch) + '.png', nrow=n)
